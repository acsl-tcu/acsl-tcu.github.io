        ...
        <table className="min-w-full table-auto text-left">
          ...
          <tbody>
            {lectures.map((lecture, index) => (
              <tr key={index} className="hover:bg-gray-50 even:bg-gray-100 dark:hover:bg-neural-300 even:bg-gray-100 dark:even:bg-neural-200 dark:bg-neutral-100 dark:text-gray-100 ">
